...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.USER_UPDATE_PROFILE_REQUEST(`/api/users/${user._id}`, user, config)
        dispatch({
